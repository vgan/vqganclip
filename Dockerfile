...
RUN apt update -y
RUN apt install -y ffmpeg task-spooler vim
...
RUN pip install ftfy regex tqdm omegaconf pytorch-lightning Mastodon.py imageio imageio-ffmpeg pandas seaborn kornia einops==0.3.0 transformers==4.3.1
